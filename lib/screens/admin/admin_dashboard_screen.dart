...
class AdminDashboardScreen extends StatelessWidget {
        ...
        Expanded(
          ...
          child: SingleChildScrollView(
            child: Padding(
              ...
              child: Column(
                children: [
                  _buildStatCards(crossAxisCount: 2),
                  SizedBox(height: 16),
                  _buildSearchBar(),
                  SizedBox(height: 16),
                  _buildOrganizationsList(),
  ...
  Widget _buildOrganizationsList() {
    return Obx(() {
      if (adminController.isLoading.value && adminController.organizations.isEmpty) {
        return Center(child: CircularProgressIndicator());
      }
  ...
  void _showEditOrganizationDialog(BuildContext context, OrganizationModel organization) {
    showDialog(
      context: context,
